...
import { crearPrograma } from "@/app/actions/coach";

export function FormNuevoPrograma({ idAlumno }: { idAlumno: string }) {
  const [state, action, pending] = useActionState(crearPrograma, undefined);
