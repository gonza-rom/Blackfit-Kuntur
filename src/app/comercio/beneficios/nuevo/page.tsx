...
import { crearBeneficioComercio } from "@/app/actions/comercio";

export default function NuevoBeneficioComercioPage() {
  const [state, action, pending] = useActionState(crearBeneficioComercio, undefined);
