...
import { editarBeneficioComercio } from "@/app/actions/comercio";
...
export function FormEditarBeneficioComercio({ beneficio }: { beneficio: Beneficio }) {
  const [state, action, pending] = useActionState(editarBeneficioComercio, undefined);
